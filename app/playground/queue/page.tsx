...
export default function QueuePlaygroundPage() {
  const {
    timeline,
    frameIndex,
    currentFrame,
      ...
      <div className="mx-auto flex w-full max-w-400 flex-col gap-4">
        <header className="rounded-xl border bg-card p-4 shadow-sm">
          <h1 className="text-xl font-semibold">
            Mini Algorithm Playground • Queue
          </h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Enqueue, dequeue, and peek elements to see how a FIFO queue works
            step by step.
          </p>
            ...
            <div className="rounded-xl border bg-card p-4 shadow-sm">
              ...
              <div className="mt-3 flex flex-col gap-2">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    className="flex-1 rounded-md bg-secondary px-3 py-2 text-sm font-medium text-secondary-foreground hover:bg-secondary/90"
                    onClick={handleDequeue}
                  >
                    Dequeue
                  </button>
                  <button
                    className="flex-1 rounded-md border bg-background px-3 py-2 text-sm font-medium hover:bg-accent"
                    onClick={handlePeek}
                  >
                    Peek
                  </button>
