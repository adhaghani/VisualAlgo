...
export default function LinkedListPlaygroundPage() {
  const {
    timeline,
    frameIndex,
    currentFrame,
    ...
    reset,
    setSpeed,
  } = useLinkedListPlayback()

  const [valueInput, setValueInput] = useState("")
  const [modeInput, setModeInput] = useState("insert-front")
      ...
      <div className="mx-auto flex w-full max-w-400 flex-col gap-4">
        <header className="rounded-xl border bg-card p-4 shadow-sm">
          <h1 className="text-xl font-semibold">
            Mini Algorithm Playground • Linked List
          </h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Insert, delete, and search in a singly linked list with animated
