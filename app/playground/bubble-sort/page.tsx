...
export default function BubbleSortPlaygroundPage() {
  const {
    timeline,
    frameIndex,
    currentFrame,
      ...
      <div className="mx-auto flex w-full max-w-400 flex-col gap-4">
        <header className="rounded-xl border bg-card p-4 shadow-sm">
          <h1 className="text-xl font-semibold">
            Mini Algorithm Playground • Bubble Sort
          </h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Generate a random array and watch bubble sort compare and swap
