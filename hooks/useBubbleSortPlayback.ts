...
import { BubbleSort } from "@/lib/bubbleSort/BubbleSort"
import type { BubbleSortStep } from "@/lib/bubbleSort/types"
...
export function useBubbleSortPlayback() {
  const [timeline, setTimeline] = useState<BubbleSortStep[]>([])
  ...
  const operationLabel = useMemo(() => {
    ...
    return `Bubble Sort • ${currentFrame.phase}`
  }, [currentFrame])
