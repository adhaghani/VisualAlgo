...
import { InsertionSort } from "@/lib/insertionSort/InsertionSort"
import type { InsertionSortStep } from "@/lib/insertionSort/types"
...
export function useInsertionSortPlayback() {
  const [timeline, setTimeline] = useState<InsertionSortStep[]>([])
  ...
  const operationLabel = useMemo(() => {
    ...
    return `Insertion Sort • ${currentFrame.phase}`
  }, [currentFrame])
